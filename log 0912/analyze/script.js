$(document).ready(function(){
	...
	res = 	"subject condition phase block trail targetId err comp distance totalTime startTimeToComplete Click TimeOUt <br/>" ;		
		...
		for(i= 0; i < row.length;i++){
			...
			if(trail == rowArray[trailIndex]){
				...
				if(trail != "-1"){
					...
					res = 	"" + subject + " " + condition  + " " + phase  + " " + block + " " + trail+ " " + targetId
