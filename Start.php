...
$(document).ready(function(){
	$("#next").click(function(){
		...
		if($('#SampleRound').is(':checked')) {
 		...
 		switch(interface){
			case "1":
				window.location.replace("http://127.0.0.1/bookmark-thridimp/standard11.html?phase="+phase+"&interface=plain&SampleRound="+SampleRound+"&subjectId="+subjectId);
			break;
			case "2":
				window.location.replace("http://127.0.0.1/bookmark-thridimp/standard12.html?phase="+phase+"&interface=randomIcon&SampleRound="+SampleRound+"&subjectId="+subjectId);
			
			break;
			case "3":
				window.location.replace("http://127.0.0.1/bookmark-thridimp/standard13.html?phase="+phase+"&interface=userselectedIcon&SampleRound="+SampleRound+"&subjectId="+subjectId);
			
			break;
			case "4":
				window.location.replace("http://127.0.0.1/bookmark-thridimp/standard13.html?phase="+phase+"&interface=autolabel&SampleRound="+SampleRound+"&subjectId="+subjectId);
			
			break;
			case "5":
				window.location.replace("http://127.0.0.1/bookmark-thridimp/standard13.html?phase="+phase+"&interface=userlabel&SampleRound="+SampleRound+"&subjectId="+subjectId);
